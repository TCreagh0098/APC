...
perimeter_txt = f"Your Perimeter is: {perimeter} (rounded to 2 significant figures)"
area_heading = "Area:"
area_txt = f"Your Area is: {area} (rounded to 2 significant figures)"
choice_txt = f"**** You chose: {shape_choice} ****"
file_txt = f"\n(This information has been automatically saved to a txt file named <{shape_choice}.txt>)"

to_write = [heading_txt, choice_txt,perimeter_heading, perimeter_txt, area_heading, area_txt, file_txt]
